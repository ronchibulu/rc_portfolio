...
<!-- For checkpoint task examples and patterns, see @C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/checkpoints.md -->
...
See `C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/verify-phase.md` for verification logic.
