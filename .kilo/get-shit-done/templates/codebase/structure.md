...
- Usage: Reference from command with `@C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/coding_proj/self_portfolio/.kilo/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/coding_proj/self_portfolio/.kilo/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
