...
<required_reading>
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/ai-frameworks.md
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/coding_proj/self_portfolio/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/coding_proj/self_portfolio/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/coding_proj/self_portfolio/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/coding_proj/self_portfolio/.kilo/agents/gsd-eval-planner.md for instructions.
