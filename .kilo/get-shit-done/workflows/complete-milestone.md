...
```bash
node "C:/coding_proj/self_portfolio/.kilo/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/retrospective.md`.
