...
```bash
INIT=$(node "C:/coding_proj/self_portfolio/.kilo/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/spec.md.
