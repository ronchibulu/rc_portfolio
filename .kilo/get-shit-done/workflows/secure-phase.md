...
```
Task(
  prompt="Read C:/coding_proj/self_portfolio/.kilo/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/SECURITY.md`
