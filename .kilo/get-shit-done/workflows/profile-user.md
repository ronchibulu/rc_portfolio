...
Key references:
- @C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/ui-brand.md (display patterns)
- @C:/coding_proj/self_portfolio/.kilo/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/coding_proj/self_portfolio/.kilo/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/coding_proj/self_portfolio/.kilo/get-shit-done/USER-PROFILE.md" "C:/coding_proj/self_portfolio/.kilo/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/coding_proj/self_portfolio/.kilo/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/user-profiling.md`
...
Reference: @C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/coding_proj/self_portfolio/.kilo/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/coding_proj/self_portfolio/.kilo/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/coding_proj/self_portfolio/.kilo/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/coding_proj/self_portfolio/.kilo/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/coding_proj/self_portfolio/.kilo/AGENTS.md"
...
```bash
BACKUP_PATH="C:/coding_proj/self_portfolio/.kilo/USER-PROFILE.backup.md"
```
...
Your profile:    C:/coding_proj/self_portfolio/.kilo/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/coding_proj/self_portfolio/.kilo/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        C:/coding_proj/self_portfolio/.kilo/AGENTS.md
```
