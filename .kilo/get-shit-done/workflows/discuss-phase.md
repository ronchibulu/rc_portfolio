...
<required_reading>
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/domain-probes.md
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/gate-prompts.md
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "C:/coding_proj/self_portfolio/.kilo/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @C:/coding_proj/self_portfolio/.kilo/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/discuss-phase-power.md
