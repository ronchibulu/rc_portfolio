...
<template>
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/coding_proj/self_portfolio/.kilo/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/diagnose-issues.md
