...
```markdown
Read C:/coding_proj/self_portfolio/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/coding_proj/self_portfolio/.kilo/agents/gsd-ui-checker.md for instructions.
