...
<execution_context>
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/docs-update.md end-to-end.
