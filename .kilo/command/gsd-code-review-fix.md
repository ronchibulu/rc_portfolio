...
<execution_context>
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/code-review-fix.md end-to-end.
