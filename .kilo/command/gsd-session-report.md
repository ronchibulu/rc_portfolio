...
<execution_context>
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/coding_proj/self_portfolio/.kilo/get-shit-done/workflows/session-report.md end-to-end.
</process>
