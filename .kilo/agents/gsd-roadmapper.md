...
Reference full template: `C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/state.md`.
