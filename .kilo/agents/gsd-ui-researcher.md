...
Use template from `C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/coding_proj/self_portfolio/.kilo/get-shit-done/templates/UI-SPEC.md`
