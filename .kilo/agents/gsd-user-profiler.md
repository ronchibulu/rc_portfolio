...
<reference>
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/user-profiling.md` to load:
