...
@C:/coding_proj/self_portfolio/.kilo/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/coding_proj/self_portfolio/.kilo/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
